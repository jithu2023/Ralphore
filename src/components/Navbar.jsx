...
function Navbar() {
  ...
  return (
    <nav className={`fixed top-0 left-0 w-full flex items-center justify-between md:justify-between ${isScrolled ? 'md:bg-white md:shadow-lg py-4' : 'bg-transparent py-6'} md:transition-all md:duration-300 z-20 ${window.innerWidth <= 768 ? 'backdrop-blur-md bg-white/30' : ''}`} style={iconStyle}>
      {/* Left Section */}
